...
{/*                     <img
            ...
            <div className="flex items-center">
                ...
                {
                        isAuthenticated ? (
                            <img onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })} src={user.picture} />
                        ) : (
                            <img onClick={() => loginWithRedirect()} src="https://xsgames.co/randomusers/assets/avatars/female/67.jpg" />
